using MVCApp1.Middleware;
using MVCApp1.Telemetry;
...
builder.Services.AddSession(options =>
{
    ...
    options.Cookie.Name = ".MVCApp1.Session";
});
...
builder.Services.AddSingleton<ITelemetryInitializer>(new CustomTelemetryInitializer("MVCApp1"));
