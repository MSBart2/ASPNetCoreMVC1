...
cleanup_with_stats "tests/MVCApp1.UnitTests/bin" "unit test bins"
cleanup_with_stats "tests/MVCApp1.UnitTests/obj" "unit test objs"
cleanup_with_stats "tests/MVCApp1.PlaywrightTests/bin" "playwright test bins"
cleanup_with_stats "tests/MVCApp1.PlaywrightTests/obj" "playwright test objs"
