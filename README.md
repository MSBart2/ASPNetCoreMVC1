...
[![Build & Test](https://github.com/rbmathis/MVCApp1/actions/workflows/dotnet.yml/badge.svg?branch=main)](https://github.com/rbmathis/MVCApp1/actions/workflows/dotnet.yml)
[![Deploy](https://github.com/rbmathis/MVCApp1/actions/workflows/deploy.yml/badge.svg?branch=main)](https://github.com/rbmathis/MVCApp1/actions/workflows/deploy.yml)
[![Copilot Agents](https://github.com/rbmathis/MVCApp1/actions/workflows/copilot-agents.yml/badge.svg?branch=main)](https://github.com/rbmathis/MVCApp1/actions/workflows/copilot-agents.yml)
...
[![Playwright Ready](https://img.shields.io/badge/Playwright-smoke%20tested-3fb950?logo=playwright&logoColor=white)](tests/MVCApp1.PlaywrightTests)
...
- `dotnet test` triggers all suites, including the Playwright smoke tests in `MVCApp1.PlaywrightTests`.
- On the first run Playwright downloads headless browser binaries automatically; alternatively, install them explicitly by executing `pwsh tests/MVCApp1.PlaywrightTests/bin/Debug/net9.0/playwright.ps1 install` from the repository root after a build (ensure your working directory is the solution root).
...
- The project generates XML docs on build: `bin/<Configuration>/<TargetFramework>/MVCApp1.xml`
